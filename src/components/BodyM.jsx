...
const BodyM = () => {
    return (
        <div className="containerSlider">
            ...
            <p><strong><h3>REPOSITORIO</h3></strong></p>

            <div className="allSlider">
               <ul className="menu">
                    <li>
                        <a href="#slide1">Proyecto #1</a>  {/*First slide*/}
                    </li>
                    <li>
                        <a href="#slide2">Proyecto #2</a>  {/*Second slide*/}
                    </li>
                    <li>
                        <a href="#slide3">Proyecto #3</a>  {/*Third slide*/}
                    </li>     
                </ul>
            ...
            <a href="#Header"><button type="button" className="ButtonH"><h3>Regresar</h3></button></a> {/* Button that takes me to the component header*/}
